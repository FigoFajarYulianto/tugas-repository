            ...
            <div class="col-12 col-md-3 kotak-kiri d-none d-sm-none d-md-block">
                ...
                <div class="kotak-kiri-sidebar">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="dropdown">
                            <div class="avatar-saya avatar-saya-<?php echo $saya['id']; ?>" id="dropdownMenuButton"
                                data-toggle="dropdown" aria-haspopup="tre" aria-expanded="flse">
                                <?php 
                        if($saya['foto_admin'] == ""){
                            ?>
                        ...
                        ?>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item pilih-status" id="online"><span
                                        class="status status-online mr-2"></span> Online</a>
                                <a class="dropdown-item pilih-status" id="diluar"><span
                                        class="status status-diluar mr-2"></span> Di luar</a>
                                <a class="dropdown-item pilih-status" id="sibuk"><span
                                        class="status status-sibuk mr-2"></span> Sibuk</a>
                                <a class="dropdown-item pilih-status" id="offline"><span
                                        class="status status-offline mr-2"></span> Offline</a>
                            </div>
                        </div>
                        <div class="mx-4" style="width: 200px;">
                            <p class="h5"><?php echo $saya['username'] ?></p>
                        </div>
                    ...
                    <div class="pencarian">
                        <div class="pencarian-inner">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control ketik-pencarian"
                                    placeholder="Masukkan Pencarian .." aria-label="Masukkan Pencarian .."
                ...
                <div class="kotak-kiri-sidebar">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="dropdown float-right ml-4">
                            <button class="btn btn-secondary float-right tombol-sembunyi-user-mobile"><i
            ...
            <div class="col-md-9 col-12 conversation">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light" style="min-height: 70px">
                    ...
                    <div class="dropdown float-right ml-4 d-block d-md-none">
                        <button class="btn btn-secondary float-right tombol-tampil-user-mobile"><i
                        ...
                        <div class="upload-btn-main">
                            <div class="upload-btn-wrapper">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <input class="upload_gambar" id="upload_gambar" type="file" name="upload_gambar"
                                        accept="image/*" />
                                </form>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="email" class="form-control"
                                    value="<?php echo $saya['nama_lengkap']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <small class="text-muted font-italic">Kosongkan jika tidak ingin mengganti
                                    password.</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div><small class="text-muted font-italic">Kosongkan jika tidak ingin mengganti foto
                                        profil.</small></div>
                            </div>
                        </div>
