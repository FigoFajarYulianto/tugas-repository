                        ...
                        <ul>
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" s
                                    ...
                                    style="color: white;">
                                    <span class="small"
                                        style="margin-right: -80px; font-size:0,7rem; font-weight: bold; color:white; font-family:Verdana, Geneva, Tahoma, sans-serif;"><?php echo $saya['user_nama']; ?></span>
    ...
    <div class="atas">
        ...
        <div class="isi">
            ...
            ?>
                    ...
                    <div class="card">
                        <img src="produk2/produk2/assets/img/produk/<?php echo $perproduk['gbr_produk'] ?>" alt=""
                        ...
                        <div class="content">
                            ...
                            <div class="buttons">
                                ...
                                <button><a href="detail.php?id=<?php echo $perproduk['id_produk']?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="row justify-content-center align-items-center profil">
                    <div class="form">
                        <img class="rounded mx-auto d-block" src="gambar/user/<?php echo $saya['user_foto']; ?>"
                        ...
                        <form action="user/profil_update.php" method="post" enctype="multipart/form-data">
                            <div class="form-grub" style="width: 400px;">
                                ...
                                <input type="text" name="nama" class="form-control"
                                    value="<?php echo $saya['user_nama']; ?>">
                            </div>
                            <div class="form-grub" style="width: 400px;">
                                <label> Email </label>
                                <input type="email" name="email" class="form-control"
                                    value="<?php echo $saya['user_email']; ?>">
                            </div>
                            <div class="form-grub" style="width: 400px;">
                                <label> Nomor Telepon </label>
                                <input type="number" name="telepon" class="form-control"
                                    value="<?php echo $saya['user_telepon']; ?>">
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="file" name="foto"
                                    style="position:absolute; top:220px; right:41px; width: 400px; margin-top:70px;"><br><br>
                            </div>
                            <small class="text-muted font-italic" style="margin-left:0px; ">Kosongkan jika tidak ingin
                                mengganti foto profil.</small>
                            <button type="submit" class="btn btn-secondary"
                                style="margin-left: 20%; margin-right: 10%; width:30%; margin-top:140px;">Update
                                profil</button>
                        </form>
                    </div>
                </div>
