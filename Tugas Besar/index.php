    ...
    <div class="isi">
        <div class="wrapper">
          <div class="row" style="margin-top: -10px;">
            <?php $ambil = "SELECT * FROM tb_produk JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan"; 
            ...
            $sql = "SELECT * FROM tb_produk JOIN satuan ON tb_produk.id_satuan=satuan.id_satuan LIMIT $halaman_awal, $batas";
            ...
            <?php while($perproduk = $query->fetch_assoc()) { ?>
              <div class="card">
                  ...
                  <div class="content">
                      ...
                      <div class="price">Rp.<?php echo number_format($perproduk['harga'])?> /<?php echo $perproduk['nama_satuan'] ?></div>
      ...
      <ul class="pagination justify-content-md-center">
        <?php 
          if($halaman == 1){
            ...
            echo "<li class='page-item'><a class='page-link' href='index.php?halaman=$previous'>Previous</a></li>";
          }
        ?>
        <?php 
        ...
        if($halaman == $total_halaman){
          ...
          echo "<li class='page-item'><a class='page-link' href='index.php?halaman=$next'>next</a></li>";
        }
        ?>
      </ul>
    </nav>
