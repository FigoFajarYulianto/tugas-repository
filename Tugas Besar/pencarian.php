...
<body>
  ...
  <?php 
    ...
    <div class="isi">
        <div class="wrapper" >
          <div class="row" style="margin-top: 10px; margin-left:11%; width:80%;">
              ...
              <div class="card">
                  ...
                  <div class="content">
                      <div class="col" style="margin-left: -30px;">
                          <div class="details">
                          <span><?php echo substr($pencarian['nama_produk'], 0, 13) ?>
      ...
      <ul class="pagination justify-content-md-center">
        <?php 
          if($halaman == 1){
            ...
            echo "<li class='page-item'><a class='page-link' href='pencarian.php?halaman=$previous'>Previous</a></li>";
          }
        ?>
        <?php 
          for($i=1; $i<=$total_halaman; $i++){
            echo "<li class='page-item'><a class='page-link' href='pencarian.php?halaman=$i'>$i</a></li>";
          }
        ?>
        <?php 
        if($halaman == $total_halaman){
          ...
          echo "<li class='page-item'><a class='page-link' href='pencarian.php?halaman=$next'>next</a></li>";
        }
        ?>
      </ul>
    </nav>
