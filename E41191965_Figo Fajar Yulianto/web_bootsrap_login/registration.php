  ...
  <?php include "./sidebar.php" ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="form-group">
     <tr>   
        <td><input type="radio"  value="pria" name="status"  required>Pria 
            <input type="radio"  value="wanita" name="status"   required>Wanita <td>     
    </tr>    
    </div>
        <div class="form-group">
        <input type="text" class="form-control form-control-user" id="agama" name="agama" placeholder="Islam" required>
        </div>
        <div class="form-group">
        ...
        if ($status) {
            echo "<strong>Jenis Kelamin:</strong> {$status} <br>";
        }
